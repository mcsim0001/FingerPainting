package ua.com.mcsim.slidinglayout;
...
/**
 * Created by mcsim on 24.05.2017.
 *
 *
 * FOR USE:
 * In Activity:
 *     View exampleSlideView = findViewById(R.id.slide_example_wiew); /slide_example_wiew - youre slide-panel xml-file/
 *     SlideLayout myExampleSlideLayout = new SlideLayout(exampleSlideView, SlideLayout.TOP) /for top oriented panel/
 *     myExampleSlideLayout.hideImmediately();
 *
 * Slide in:
 *     myExampleSlideLayout.animateIn();
 *
 * Slide out:
 *     myExampleSlideLayout.animateOut();
 *
 *
 */

public class SlideLayout implements OnTouchListener, AnimatorUpdateListener, AnimatorListener{
    private View view;
    private float touchableArea;
    private int autoSlideDuration = 300;
    private int positionOnScreen;
    private SlideLayout.SlideListener slideListener;
    ...
    private static final String LOG = "SlideLayout";


    public SlideLayout(final View view, int pos) {
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            public void onGlobalLayout() {
                if(SlideLayout.this.hiddenInit) {
                    SlideLayout.this.viewHeight = (float)view.getHeight();
                    SlideLayout.this.viewWidth = (float)view.getWidth();
                    SlideLayout.this.hideImmediately();
                }
